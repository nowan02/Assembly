; Stepping back in [di]s address does not yield an expected value when using /?
...
Code Segment
	...
	Instructions:
	             db     "Enter a two digit number which will be velocity of the ball. For single digit velocity, write a 0 and a number$"
